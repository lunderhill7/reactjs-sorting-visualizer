    ...
    return (
        <div className="mt-4 mb-4 flex flex-col items-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-6"> 
                ...
                <button
                    onClick={() => changeAlgorithm("heap_sort")}
                    className={`bg-carbon text-white px-5 py-3 rounded-3xl ${
                        sortingState.algorithm === "heap_sort" ? "bg-turquoise-dark" : "hover:bg-carbon-light"
                    } transition-all`}
                >
                     Heap Sort
                </button>
                <button
                    onClick={() => changeAlgorithm("shell_sort")}
                    className={`bg-carbon text-white px-5 py-3 rounded-3xl ${
                        sortingState.algorithm === "shell_sort" ? "bg-turquoise-dark" : "hover:bg-carbon-light"
                    } transition-all`}
                >
                     Shell Sort
                </button>
